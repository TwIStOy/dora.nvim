...
---@param self dora.lib.promise.Promise
function PromisePrototype.next(self, ...)
...
PromisePrototype["then"] = function(self, on_fulfilled, on_rejected)
  ...
  if on_fulfilled ~= nil then
    local callback =
      self:create_promise_resolving_callback(on_fulfilled, resolve, reject)
  ...
  if on_rejected ~= nil then
    local callback =
      self:create_promise_resolving_callback(on_rejected, resolve, reject)
...
function PromisePrototype.create_promise_resolving_callback(
  self,
  f,
  resolve,
  reject
